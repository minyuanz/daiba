    ...
    >
      ...
      <article>
        ...
        <p>
          ...
          走進百年街坊與新興文創的迪化街，<br />
          午後踏上陽明山享受大自然的美好，<br />
          當捷運由傍晚昏黃，駛進夜裡的霓虹光亮，<br />
          停留在士林夜市，美食的豐富性讓人垂涎三尺，<br />
          在深夜，信義區的酒吧開啟了台北的不夜城，<br />
          晚安，台北。
        </p>
      </article>
    </div>
    ...
    >
      <article>
        ...
        <p>
          ...
          而台北的美好不能只有我們知道，<br />
          現在網路上玲瓏滿目的旅遊介紹文章，<br />
          到底哪一個才是正確的資訊、有可靠性的呢?<br />
          不用想了!! 看這裡就對了!!<br />
          我們以台北捷運為出發點，蒐集了每個捷運站更詳細的旅遊資訊，<br />
          以及在地人才知道的景點美食，<br />
          不僅能瀏覽我們推薦的旅遊行程，<br />
          我們也希望各位歹霸俗也能投稿文章，<br />
          分享我們也不知道的台北。<br />
...
<script>
import background1 from "@/assets/images/about_bgc1.svg";
import background2 from "@/assets/images/about_bgc2.svg";
...
<style lang="scss">
@import "../assets/scss/page/_about";
</style>
